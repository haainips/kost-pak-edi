<x-default-layout>
    ...
    <header class="bg-white dark:bg-white">
        <section class="h-[screen] ">
                ...
                <div class="items-center lg:flex">
                    <div class="w-full lg:w-1/2">
                        <div class="lg:max-w-lg">
                            <h1 class="text-3xl font-semibold text-gray-800 lg:text-4xl">Hunian Orang <span class="text-blue-500 ">Pintar</span></h1>
                            
                            <p class="mt-3 text-gray-600 dark:text-gray-400">Miliran, destinasi hunian nyaman dan terjangkau di tengah kota Yogyakarta. Pengelolaan langsung
                    ...
                    <div class="flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2">
                        <img class="w-full h-full lg:max-w-2xl" src="{{asset('storage/images/logo3.jpeg')}}" alt="Catalogue-pana.svg">
                    </div>
                </div>
            </div>
            {{-- <div class="lg:flex p-10 ">
                ...
                <div class="w-full h-64 lg:w-1/2 lg:h-auto">
                    <div class="w-[30rem] h-[30rem] bg-cover"
        ...
        <section class="bg-white py-11 lg:h-[60rem] h-[100rem] mt-[5rem]" id="about">
            <div class="container max-w-5xl mx-auto m-8 px-6">
                ...
                <div class="flex flex-col lg:flex-row items-center justify-between mt-10">
                    <img src="{{ asset('storage/images/kost2.jpeg') }}" class="mt-2" width="400" height="300">
                    <img src="{{ asset('storage/images/kost1.jpeg') }}" class="mt-2" width="400" height="300">
                </div>
        ...
        {{-- Place & Maps Section --}}
        <section class="bg-gray-800 h-screen lg:h-[35rem] py-5">
            <div class="container flex flex-col px-6 py-10 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center">
                <div class="w-full lg:w-1/2">
                    <div class="lg:max-w-lg">
                        <h1 class="text-3xl font-semibold tracking-wide text-white lg:text-5xl text-center py-5">
                            Meet Us At</h1>
                        <h2 class="text-xl lg:text-lg font-semibold tracking-wide text-white text-center">Mliiran UH II / 227 RT 04 RW 02 MUJA MUJU Yogyakarta</h2>
                    </div>
                </div>
                <div class="flex items-center justify-center h-[30rem] lg:w-1/2 ">
